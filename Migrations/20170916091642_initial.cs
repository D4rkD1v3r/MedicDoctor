...
namespace rmiMedicineDoctor.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalDoctors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalDoctors_AspNetUsers_IdentityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalDoctors_IdentityId",
